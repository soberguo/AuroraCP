...
class CustomAurora(nn.Module):
    ...
    def forward(self, batch):
        big_batch=Batch(
                surf_vars={"2t": batch.surf_vars['2t'], "10u":batch.surf_vars['10u'], "10v":batch.surf_vars['10v'],"tp":batch.surf_vars['tp']},
        ...
        enc_feat,dec_feat=self.small_model(small_batch)
        hyp_x=tuple((enc_feat,dec_feat))
