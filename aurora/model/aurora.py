...
from aurora.model.swin3d import BasicLayer3D_dec, Swin3DTransformerBackbone
...
class Aurora(torch.nn.Module):
    ...
    def forward(self, batch: Batch,hyp_x) -> Batch:
        """Forward pass.
    ...
    def configure_activation_checkpointing(self):
        ...
        """
        apply_activation_checkpointing(self, check_fn=lambda x: isinstance(x, BasicLayer3D_dec))
